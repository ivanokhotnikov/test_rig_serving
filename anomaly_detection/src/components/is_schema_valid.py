...
def is_schema_valid(uploaded_file):
    """
    The is_schema_valid function checks whether the uploaded file has the correct schema. It returns True if it does and False otherwise.
    
    Args:
        uploaded_file: Pass the file that is uploaded by the user
